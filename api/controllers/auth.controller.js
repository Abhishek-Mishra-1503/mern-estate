...
export const signin=async(req,res,next)=>{
    ...
    try{
        ...
        const {password: pass, ...rest} = validUser._doc  // here we destructured the validUser. one part contains the password field of validUser and its named as pass because password variable has already been used and the other part named as rest contain all other fileds of validUser 
